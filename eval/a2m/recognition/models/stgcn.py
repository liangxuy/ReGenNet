...
class STGCN(nn.Module):
    ...
    def __init__(self, in_channels, num_class, num_person, graph_args,
        ...
        self.st_gcn_networks = nn.ModuleList((
            st_gcn(in_channels//self.num_person, 64, kernel_size, 1, residual=False, **kwargs0),
    ...
    def forward(self, batch):
        ...
        if self.num_person == 2:
            N, V, C, T = batch["output"].shape
            C = C // self.num_person
            M = 2
            x = batch["output"].reshape((N, V, M, C, T))
