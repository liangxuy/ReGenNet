...
MODELTYPES = ["cvae", "gan", "kgan"]  # not used: "cae"
ARCHINAMES = ["fc", "gru", "transformer", "transformer2", "timesformer", "timesformer1", "timesformer2", "transgru", "grutrans", "autotrans"]
...
def get_model(parameters):
    ...
    if modeltype == 'gan' or modeltype == 'kgan':
        return Model(**parameters).to(parameters["device"])
